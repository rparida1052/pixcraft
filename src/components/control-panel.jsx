    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="flex space-x-2">
            <input
              ...
              onChange={(e) => onCropDimensionsChange({ ...cropDimensions, width: Number(e.target.value) })}
            ...
            <input
              ...
              onChange={(e) => onCropDimensionsChange({ ...cropDimensions, height: Number(e.target.value) })}
              className="w-1/2 px-3 py-2 border rounded"
              placeholder="Height"
            />
          </div>
        ...
        <p className="text-sm text-gray-500 mt-2">
          Note: To print without headers and footers, please disable them in your browser's print settings.
        </p>
      </div>
    </div>
  )
